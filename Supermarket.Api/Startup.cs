...
namespace Supermarket.Api
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<SupermarketContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DevConnection"), x => x.MigrationsAssembly("Supermarket.Data")));
            services.AddCors();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCorsMiddleware(new string[] { "https://localhost:44379/" });
